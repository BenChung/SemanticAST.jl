...
expr_tests() = [
	:function => [
		...
		"function foo(a) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(IdentifierAssignment(:a), nothing)], [], [], nothing, Block([]))",
		"function foo(a::Int) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(TypedAssignment(IdentifierAssignment(:a), Variable(:Int)), nothing)], [], [], nothing, Block([]))",
		"function foo(a::Int, b::Int) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(TypedAssignment(IdentifierAssignment(:a), Variable(:Int)), nothing), FnArg(TypedAssignment(IdentifierAssignment(:b), Variable(:Int)), nothing)], [], [], nothing, Block([]))",
		"function foo(a::Int, b::Int, c=2) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(TypedAssignment(IdentifierAssignment(:a), Variable(:Int)), nothing), FnArg(TypedAssignment(IdentifierAssignment(:b), Variable(:Int)), nothing), FnArg(IdentifierAssignment(:c), Literal(2))], [], [], nothing, Block([]))",
		...
		"function foo(a; c::Int=2) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(IdentifierAssignment(:a), nothing)], [KwArg(:c, Variable(:Int), Literal(2), false)], [], nothing, Block([]))",
		"function foo(a; c::Int) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(IdentifierAssignment(:a), nothing)], [KwArg(:c, Variable(:Int), nothing, false)], [], nothing, Block([]))",
		"function foo(a; c::Int, d) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(IdentifierAssignment(:a), nothing)], [KwArg(:c, Variable(:Int), nothing, false), KwArg(:d, nothing, nothing, false)], [], nothing, Block([]))",
		"function foo((a,b), c) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(TupleAssignment([IdentifierAssignment(:a), IdentifierAssignment(:b)]), nothing), FnArg(IdentifierAssignment(:c), nothing)], [], [], nothing, Block([]))",
		"function foo((a,b)...) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(VarargAssignment(TupleAssignment([IdentifierAssignment(:a), IdentifierAssignment(:b)])), nothing)], [], [], nothing, Block([]))",
		"function foo(a, b..., c) end" => ErrorResult(),
		"function foo(; (a,b)::Tuple{Int, Int} = (1, 2)) end" => ErrorResult(),
		"function foo(; (a,b)) end" => ErrorResult(),
		"function foo((;a,b)) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(NamedTupleAssignment([IdentifierAssignment(:a), IdentifierAssignment(:b)]), nothing)], [], [], nothing, Block([]))",
		"function foo((;a=2,b)) end" => ErrorResult(),
		"function foo((;a,b)::Int) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(TypedAssignment(NamedTupleAssignment([IdentifierAssignment(:a), IdentifierAssignment(:b)]), Variable(:Int)), nothing)], [], [], nothing, Block([]))",
		...
		"function foo(a) where {T} where {U, V} end" => "FunctionDef(ResolvedName([:foo]), [FnArg(IdentifierAssignment(:a), nothing)], [], [TyVar(:U, nothing, nothing), TyVar(:V, nothing, nothing), TyVar(:T, nothing, nothing)], nothing, Block([]))",
		"function foo(a; b::T) where {T} where {U, V} end" => "FunctionDef(ResolvedName([:foo]), [FnArg(IdentifierAssignment(:a), nothing)], [KwArg(:b, Variable(:T), nothing, false)], [TyVar(:U, nothing, nothing), TyVar(:V, nothing, nothing), TyVar(:T, nothing, nothing)], nothing, Block([]))",
		"function foo(a, a) end" => ErrorResult(),
		"function foo(a::Int, a::Int) end" => ErrorResult(),
		"function foo((a,b), b::Int) end" => "FunctionDef(ResolvedName([:foo]), [FnArg(TupleAssignment([IdentifierAssignment(:a), IdentifierAssignment(:b)]), nothing), FnArg(TypedAssignment(IdentifierAssignment(:b), Variable(:Int)), nothing)], [], [], nothing, Block([]))",
		...
		"function (a) end" => "FunctionDef(AnonFuncName(), [FnArg(IdentifierAssignment(:a), nothing)], [], [], nothing, Block([]))",
		"function (a::Int) end" => "FunctionDef(AnonFuncName(), [FnArg(TypedAssignment(IdentifierAssignment(:a), Variable(:Int)), nothing)], [], [], nothing, Block([]))",
		"function (a::Int, b::Int) end" => "FunctionDef(AnonFuncName(), [FnArg(TypedAssignment(IdentifierAssignment(:a), Variable(:Int)), nothing), FnArg(TypedAssignment(IdentifierAssignment(:b), Variable(:Int)), nothing)], [], [], nothing, Block([]))",
		"function (a::Int, b::Int, c=2) end" => "FunctionDef(AnonFuncName(), [FnArg(TypedAssignment(IdentifierAssignment(:a), Variable(:Int)), nothing), FnArg(TypedAssignment(IdentifierAssignment(:b), Variable(:Int)), nothing), FnArg(IdentifierAssignment(:c), Literal(2))], [], [], nothing, Block([]))",
		"function (a::Int, b::Int, c=2, d::Int) end" => ErrorResult(),
		"function foo end" => "FunctionDef(ResolvedName([:foo]), [], [], [], nothing, nothing)",
		"function (::Type{T})(x) end" => "FunctionDef(DeclName(nothing, CallCurly(Variable(:Type), [Variable(:T)])), [FnArg(IdentifierAssignment(:x), nothing)], [], [], nothing, Block([]))",
	...
	:macro => [
		...
		"macro foo(a) end" => "MacroDef(ResolvedName([:foo]), [FnArg(IdentifierAssignment(:a), nothing)], [], nothing, Block([]))",
		"macro foo(a::Int) end" => "MacroDef(ResolvedName([:foo]), [FnArg(TypedAssignment(IdentifierAssignment(:a), Variable(:Int)), nothing)], [], nothing, Block([]))",
		"macro foo(a::Int, b::Int) end" => "MacroDef(ResolvedName([:foo]), [FnArg(TypedAssignment(IdentifierAssignment(:a), Variable(:Int)), nothing), FnArg(TypedAssignment(IdentifierAssignment(:b), Variable(:Int)), nothing)], [], nothing, Block([]))",
		"macro foo(a::Int, b::Int, c=2) end" => "MacroDef(ResolvedName([:foo]), [FnArg(TypedAssignment(IdentifierAssignment(:a), Variable(:Int)), nothing), FnArg(TypedAssignment(IdentifierAssignment(:b), Variable(:Int)), nothing), FnArg(IdentifierAssignment(:c), Literal(2))], [], nothing, Block([]))",
	...
	:do => [
		...
		"f() do x, y; body end" => "DoStatement(FunCall(Variable(:f), [], []), [FnArg(IdentifierAssignment(:x), nothing), FnArg(IdentifierAssignment(:y), nothing)], Block([Variable(:body)]))",
		"f(x) do y body end" => "DoStatement(FunCall(Variable(:f), [PositionalArg(Variable(:x))], []), [FnArg(IdentifierAssignment(:y), nothing)], Block([Variable(:body)]))"
	],
	:tuple => [
